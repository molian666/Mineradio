...
test('2.1.1 update metadata accepts only a bounded HTTPS external page', () => {
  assert.equal(packageData.version, '2.1.1');
  ...
  assert.match(htmlText, /id="update-modal-version"[^>]*>v2\.1\.1</);
